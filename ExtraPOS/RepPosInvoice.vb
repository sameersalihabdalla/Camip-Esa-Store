...
Public Class RepPosInvoice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ExtraPOS.RepPosInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepPosInvoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepPosInvoice = New RepPosInvoice()
        rpt.Site = Me.Site
        Return rpt
    End Function

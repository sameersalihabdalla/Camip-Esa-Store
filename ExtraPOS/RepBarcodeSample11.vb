...
Public Class RepBarcodeSample1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ExtraPOS.RepBarcodeSample1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepBarcodeSample1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepBarcodeSample1 = New RepBarcodeSample1()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class RepProductWin
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ExtraPOS.RepProductWin.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepProductWin
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepProductWin = New RepProductWin()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class RepStockStatus
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ExtraPOS.RepStockStatus.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepStockStatus
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepStockStatus = New RepStockStatus()
        rpt.Site = Me.Site
        Return rpt
    End Function

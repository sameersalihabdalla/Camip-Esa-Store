...
Public Class RepPosInvoicepaid
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ExtraPOS.RepPosInvoicepaid.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepPosInvoicepaid
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepPosInvoicepaid = New RepPosInvoicepaid()
        rpt.Site = Me.Site
        Return rpt
    End Function
